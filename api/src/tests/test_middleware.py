...
class TestRequestIDMiddleware:
    ...
    def test_request_id_header_added_to_response(self, client: TestClient):
    ...
    def test_request_id_available_in_endpoint_context(self, client: TestClient):
    ...
    def test_request_id_works_with_post_requests(self, client: TestClient):
    ...
    def test_request_start_logged(self, mock_logger, client: TestClient):
    ...
    @patch("app.core.middleware.logger")
    def test_request_completion_logged(self, mock_logger, client: TestClient):
    ...
    @patch("app.core.middleware.logger")
    def test_request_with_query_params_logged(self, mock_logger, client: TestClient):
    ...
    @patch("app.core.middleware.logger")
    def test_error_request_logged(self, mock_logger, client: TestClient):
    ...
    def test_request_id_context_isolated_between_requests(self, client: TestClient):
    ...
    def test_get_request_id_function_outside_request_context(self):
    ...
    def test_get_request_id_function_with_manual_context(self):
    ...
    def test_request_id_format_is_uuid4(self, client: TestClient):
    ...
    def test_middleware_preserves_response_status_codes(self, client: TestClient):
    ...
    def test_structlog_context_binding(self, mock_bind, client: TestClient):
    ...
    def test_structlog_context_cleared_after_request(self, mock_clear, client: TestClient):
    ...
    @patch("app.core.middleware.structlog.contextvars.clear_contextvars")
    def test_structlog_context_cleared_even_on_error(self, mock_clear, client: TestClient):
